...
<tr>
    ...
    <?=HTML::anchor('page/'. $page->alias, HTML::image('media/images/see.png'), array('target' => '_blank'))?>
    
    <?=HTML::anchor('admin/pages/edit/'. $page->id, HTML::image('media/images/edit.png'))?>

    <?=HTML::anchor('admin/pages/delete/'. $page->id, HTML::image('media/images/delete.png'))?>
