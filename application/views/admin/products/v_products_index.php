...
<tr>
    ...
    <?=HTML::anchor('admin/products/edit/'. $product->id, HTML::image('/media/images/edit.png'))?>

    <?=HTML::anchor('admin/products/delete/'. $product->id, HTML::image('/media/images/delete.png'))?>
